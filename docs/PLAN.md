...
- Fase: kickoff completato, scaffold in PR (#48). Prossimo: M0.
...
| 6   | Installare Docker Desktop e collegare Supabase                                  | chore | -          | needs-human | azione dell utente |
| 7   | Deploy automatico su Vercel da main con preview per PR                          | chore | 48         | needs-human | azione dell utente |
...
| 11  | Schema iniziale DB: mondi, membri, categorie, snippet, relazioni con RLS        | feat  | 6          | todo        |                    |
