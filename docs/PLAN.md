...
- Fase: M0 in corso: restano #57, #59 (needs-human) e #60.
...
| 13  | Mondi: creazione, elenco, impostazioni, membri e ruoli                          | feat  | 11, 12     | in PR       | elenco, creazione, rinomina, elimina; membri in #60       |
...
| 57  | Login con OAuth (GitHub)                                                        | feat  | 12         | needs-human | credenziali OAuth in Supabase                             |
| 59  | Collegare Supabase cloud e Vercel (env, migrazioni, redirect URL)               | chore | 12         | needs-human | senza, la preview non funziona                            |
| 60  | Membri del mondo: inviti, ruoli, uscita, trasferimento                          | feat  | 13         | todo        | RPC add_world_member e transfer                           |

## Bloccato in attesa dell'utente (`needs-human`)

- #59 Env Vercel, migrazioni sul cloud, redirect URL Supabase (l'app in preview non funziona finché manca)
- #57 Credenziali OAuth GitHub in Supabase
- #6 Verifica del collegamento al progetto cloud (coperta da #59)
